		...
		<tr>
			<td class="tableData">
				...
				<ol>
					...
					<li>You could go to the <a href="'.$DIR_PREFIX.'labels.php">labels page</a> and follow the directions to produce a label for the UPC field of "Animal House."  This method also allows you to make labels for multiple items.</li>
				</ol>
				<p>After you choose one of these two methods, you will be presented with a graphic that looks like this:</p>
				<p style="text-align: center;"><img src="'.$DIR_PREFIX.'images/sample_label.png" alt="Animal House UPC label" /></p>
