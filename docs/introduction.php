...
$output .= '
	...
	<p>The reason that anyInventory can be so powerful and flexible is the way the you, the user, enter data.  Instead of starting by entering in items into the inventory, you start by defining what data you want to track.  For a more in-depth look at this data, continue on to read about <a href="fields.php">fields</a>.</p>
		</td>
	</tr>
