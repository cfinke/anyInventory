...
$output .= '
	...
	<p><b>More search options:</b> Soon, anyInventory will have a better advanced search page.  You will be able to specify, for each field, if the value you enter should match items with values equal to, not equal to, less than, or greater than that value.  Other improvements are planned as well.</p>
