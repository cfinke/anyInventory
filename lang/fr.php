...
define('DELETE_ITEM_CONFIRM','Etes-vous sur de vouloir supprimer cet article?');
...
define('TIMED_ONLY_LABEL','Faire que cette alerte soit <a href="../docs/alerts.php#time_based">bas&eacute; sur le temps seulement</a>.');
