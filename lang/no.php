...
define('PAGE_DIMENSIONS','Side størrelse');
define('LABEL_DIMENSIONS','Etikett størrelse');
define('ROWS','rader');
...
define('ACTIVE_WHEN','Aktiv når');
define('FOOTER_TEXT_PRE','du har lagerført');
define('ANYINVENTORY_LINK','<a href="http://anyinventory.sourceforge.net/">anyInventory, den mest fleksible og kraftige web-baserte lagerføringsløsningen</a>');
...
define('SUBMIT_REPORT','Du kan bistå i utviklingen av anyInventory ved å <a href="https://sourceforge.net/tracker/?func=add&amp;group_id=110239&amp;atid=655777">sende inn denne feilen som en feilmelding</a>.');

// Search
define('SEARCH','Søk');
define('SEARCH_RESULTS','Søkeresultat');
define('IN','i');
define('NO_RESULTS','Ingen treff');
define('NO_MATCHING_ITEMS','Det var ingen treff for ditt søkekriterie.');

// Error messages
define('ERROR','Feil');
define('ACCESS_DENIED','Ikke tilgang');
define('ERROR_DUPLICATE_FIELD',"Det finnes allerede et felt med det navnet du benyttet. Om du ønsker å legge til et felt til flere kategorier så redigerer du feltet og velger flere kategorier ved å holde nede CTRL-tasten.");
define('ERROR_BAD_DEFAULT_VALUE',"Standardverdien du har angitt for en liste eller radiofelt må være inkludert i listen av verdier.");
define('ERROR_EMPTY_CATEGORY',"Det var ingen enheter i kategoriene du valgte; det mæ være enheter i en kategori før du kan sette opp varsel for den.");
define('ERROR_NO_COMMON_FIELDS',"Ingen felles felt i kategoriene du valgte.");
define('ERROR_ALERT_NO_CATEGORIES','Et varsel må gjelde for minst en kategori.');
define('ERROR_ALERT_NO_ITEMS','Et varsel må gjelde for minst en enhet.');
define('ERROR_NO_TOP_LEVEL_EDIT',' '.TOP_LEVEL_CATEGORY.' kategorien kan ikke redigeres eller slettes.');
define('ERROR_NO_VALUES','Du må angi en liste av verdier for dette feltet.');
define('ERROR_PRIVELEGES','Du har ikke de nødvendige rettigheter.');
...
define('SIZE','Størrelse (antall tegn)');
...
define('DELETE_FIELD_CONFIRM','Er du sikker på at du ønsker å slette dette feltet?');
define('NONE','Ingen');
define('FIELD_CATS_PRE','Dette feltet er brukt i');
define('AUTO_INCREMENT','automatisk økning');
define('SHOW_AUTOINC_FIELD','Vis automatisk ønsings feltet');
...
define('UP_LINK','opp');
define('EDIT_AUTOINC_FIELD','Rediger automatisk øknings feltet');
define('EDIT_FRONT_PAGE_TEXT','Rediger hovedside tekst');
define('EDIT_NAME_FIELD','Rediger navnefeltet');
define('APPLY_FIELDS',"Bruk denne kategoriens felt på alle underkategorier.");
...
define('DELETE_CATEGORY_CONFIRM','Er du sikker på at du vil slette denne kategorien?');
...
define('DELETE_ITEM_CONFIRM','Er du sikker på at du ønsker å slette denne enheten?');
...
define('ALERT_TITLE','Navn på varsel');
define('TIMED_ONLY_LABEL','Gjør dette varslet kun <a href="../docs/en/alerts.php#time_based">tidsbasert</a>.');
...
define('DELETE_ALERT_CONFIRM','Er du sikker på at du ønsker å slette dette varslet?');
define('EDIT_ALERT','Rediger varsel');
define('EXPIRATION_DATE','Utløpsdato');
define('ALLOW_EXPIRATION','La varslet få lovt til å utløpe');
define('EMAIL_ALERT_TO','Send e-post varsel til');
define('EMAIL_ALERT_INFO','Hvis du ikke ønsker å bli varslet via e-post når dette varslet er aktivt lar du feltet være blankt.');
...
define('DELETE_USER_CONFIRM','Er du sikker på at du ønsker å slette denne brukeren?');
